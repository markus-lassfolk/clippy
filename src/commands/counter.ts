...
export const counterCommand = new Command('counter')
  ...
  .argument('<start>', 'Proposed start time (e.g., 13:00, 1pm, 2023-12-01T13:00)')
  .argument('<end>', 'Proposed end time (e.g., 14:00, 2pm, 2023-12-01T14:00)')
  ...
  .action(
    async (
      ...
      startTime: string,
      endTime: string,
      options: { day: string; token?: string }
    ) => {
