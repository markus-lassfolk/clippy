/**
 * Exercise graph-viva-client wrappers via global fetch mock (avoids mock.module leaking across files in Bun).
 */
import { afterAll, beforeAll, describe, expect, it } from 'bun:test';

describe('graph-viva-client API wrappers (fetch mock)', () => {
